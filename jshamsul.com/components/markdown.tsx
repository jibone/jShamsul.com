const Heading1Tag: React.FC = ({ children }) => {
  return (
    <h1 className="text-4xl tracking-tight leading-tight mb-6">{children}</h1>
  );
};

const Heading2Tag: React.FC = ({ children }) => {
  return (
    <h2 className="text-2xl tracking-tight leading-tight mb-6">{children}</h2>
  );
};
...
const AnchorTag: React.FC = ({ children, ...props }) => {
  return (
    <a
