...
type: 'Blog'
date: '2023-11-07'
summary: 'First post. Why I decide to start writing.'
---
...
But, this post is not about how I use Next.js with [Contentlayer](https://Contentlayer.dev) and [MDX](https://mdxjs.com) to turn this website into a personal blog. That is not what the word “Next” in the title is referring to.
