...
There was a short period of time — two and a half years or so — in my career history I was an engineering manager. At one point, I had 11 full-stack engineers reporting under me. It was a short stint, I switched back to an individual contributor role as soon as I had the opportunity to do so. 

I decided to switch back because I feel that I don’t have what it takes for the role. However, my short experience had been an eye-opening for me. It is good to step into the other side and experience it for yourself.
...
But then again, does having plenty of processes slow the team down?  There are probably procedures and processes already in place, but nobody cares and bypasses them anyway. Oftentimes, software engineers perceive these processes as bureaucratic red tape that hinders their ability to ship code.
...
Most of the time, meetings are formality rituals. Actual discussions happened before the meeting, better when it is asynchronous. You may need a face-to-face interaction, do that when needed, and update that document page with whatever that were decided, and have the other party confirm to what you have written down. Written down confirmations are better than verbal confirmations. 
...
To start with “No” to a request — that you know that you can’t do it — shut down innovation and creative thinking. Instead, you should explore the constraints, trade-offs, and find other potential paths forward (no matter how crazy it may seem) to achieve the desired outcome.
...
Don’t mistake what I am saying here as to blindly saying “yes” to everything. This is more about being a problem-solver and creative thinker who adds value, rather than a gatekeeper who focuses solely on limitations.
