...
nostrNoteId: "note1dl3vkjpzwhltq2jq6rw5a2a7znjstd2s3xd5srpqdz3rw6fun55qg3rrmr"
relatedEssays:
  ...
  - "2024-07-22-monolith-or-micro-service"
---
...
Fourth, we need to **build more federated and decentralised alternatives**. Instead of giant centralised platforms that own everything, we need many small, interconnected systems built on open standards and true data portability. In this model, users own their identity and data, and can freely move from one platform to another without friction.
