...
But AI doesn’t need to be confined to our interface conventions. It doesn’t need to click buttons or open files. It could (perhaps should) **operate at a much lower level of abstraction.**
