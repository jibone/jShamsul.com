  ...
  return (
    <Layout page="about">
      <div className="prose-custom">
        ...
        <p>
          When I&rsquo;m not writing code, I write prose, short and long,
          ranging from personal anecdotes in tech to philosophical musings on
          how technology shapes culture, society, and the individual self.
        </p>
